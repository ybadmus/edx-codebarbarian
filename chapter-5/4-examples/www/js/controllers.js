...
//FaceBook login for both device and browser.
  $scope.login = function() {
    ...
    if ($window.cordova) {
      ...
      //This is because of google chromes same origin policy for window.open. It tells 
      //REST APi to redirect to current URI.
